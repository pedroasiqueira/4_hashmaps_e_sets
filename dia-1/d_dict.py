...
# Outros métodos para manipulação de dados DICT:
# https://docs.python.org/3/tutorial/datastructures.html#dictionaries Documentação oficial da classe Dict
# https://docs.python.org/3/library/stdtypes.html#dict Métodos da classe Dict